...
const Map = forwardRef(
  ({ location, locations, setTicketVisible, time, price }, ref) => {
      ...
      return {
        ...
        <div style="position: relative; display: flex; flex-direction: column; align-items: center; opacity: ${
          ...
          <div style="
            ...
            margin-top: 2px;
          ">
            <p style="font-size: 8px; font-weight: 500; margin: 0;">${time}</p>
            <p style="margin: 4px 0 0 0;font-size: 10px;" >${
              loc.price_per_10min === 0 ? "무료" : loc.price_per_10min * price
            }</p>
          </div>
        </div>
      `,
